...
class AWSConfig:
    ...
    def get_db_config(self):
        return {
            'host': self._get_config_value("USER_DB_HOST"),
            'db_name': self._get_config_value("USER_DB_NAME"),
            'username': self._get_config_value("USER_DB_USERNAME"),
            'password': self._get_config_value("USER_DB_PASSWORD"),
        }
